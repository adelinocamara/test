...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function setEventHandlers() {
    ...
    btnCalculate.addEventListener('click', function(e) {
      ...
      // Calcular resultados sin navegar todavía
      const allAnswered = calculateResults();
      
      if (allAnswered) {
        console.log('Resultados calculados correctamente');
        setTimeout(function() {
          // Ir directamente al índice del paso de resultados (probablemente 3)
          stepperEl.to(3); // Asumiendo que los resultados son el paso 4 (índice 3)
