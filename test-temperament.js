...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function setEventHandlers() {
    // *** IMPORTANTE: ELIMINAR EL MANEJADOR EXISTENTE ANTES DE AGREGAR UNO NUEVO ***
    btnCalculate.removeEventListener('click', calculateHandler);
    
    // Botón para calcular resultados - UN SOLO MANEJADOR
  ...
  // Función para manejar el cálculo de resultados - DEFINIDA FUERA PARA EVITAR DUPLICACIÓN
